...
import com.lemon.rpcframe.zookeeper.ChildListener;
...
import com.lemon.rpcframe.zookeeper.ZookeeperClient;
...
public class ZookeeperRegistry extends FailbackRegistry {
    ...
    public ZookeeperRegistry(Config config) {
        ...
        this.zkClient = GuiceDI.getInstance(CuratorZKClient.class);
