...
import com.lemon.rpcframe.util.CollectionUtils;
...
import com.lemon.rpcframe.zookeeper.StateListener;
...
public class CuratorPlateRegistry extends RecoveryPlatRegistry {
    ...
    public CuratorPlateRegistry() {
        curatorClient = GuiceDI.getInstance(CuratorZKClient.class);
    ...
    public void subscribeChildChange(Node node, Object obj) throws Exception {
        ...
        for (String group : listenNodeGroups) {
            logger.info(String.format("Add listener on type: %s", group));
